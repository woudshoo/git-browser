...
#+nil (defparameter *revisions-store* nil)
...
;; DR 005400 wrong target pool
;; FR 01006 bug hunting
;; lapack
;; FR 01804 add unit tests to StorageMagic
;; signing
;; FR 01818 event binding examples
;; tom specific build changes
;; test gui factory
;; mkl incorperation
;; B 001770
;; Excel Utility
;; master test converted datafiles
;; Total 12

(defparameter *storage-magic-dead-revisions* 
  '("256F0F0692C8FE71E82C6B7817A4118EFAED43B8"
    "D0D77503773908B3679DABD609C2A92EC06B596B"
    "26E3E0F6265F7BDAE42C83C074E1D40746E46D68"
    "105D0FFDA0A7C2CC6316A01F961C0A1D8EEE3276"
    "15A9603248FE347B3FE3E349FAB1EEB2D9EAB751"
    "0226F57E979CAE492CC31B2A1B0DAE64413D86F7"
    "66BDCD836565804C7412DE69CF368A8C9664F320"
    "21C0E52BB433C20302EE5D2DDD2A0043F12C68CA"
    "40CC8E0D6C86A44F535B10530B187F8F49056F12"
    "90B9E3A394EDAC8F425FD1309F03276ED3ED4E25"
    "F76477AF1FA51DEF4C026168DA9AF4FFA92E7372"
    "B61C992C3C30C5B5F3E22D32167E929EB8E3AE78"))

(defparameter *dead-revisions* 
  (concatenate 'list *storage-magic-dead-revisions*
	       '("F0BCC1A07FFB8E0BC0098B679C5BB79C92208337"
...
(defun read-graph (&optional (git-project *git-project*))
  "Read the git repository GIT-PROJECT so that the the server has something to show.
The GIT-PROJECT should point to a .git directory.  It defaults to the special variable
*git-project*.

This is run for its side effects.  The side effects are that:
- *default-graph* is set to the content of the revision graph.
- *revisions-store* is set to a new store containing all revisions."
  (setf *default-graph* (wo-git:get-git-graph git-project 
					      (complement 
					       (lambda (x) 
						 (cl-ppcre:scan *ignore-names* x)))))
#+nil  (setf *revisions-store* (make-instance 'git-revision-store))
#+nil  (loop :for name :in (all-names *default-graph*)
     :do
